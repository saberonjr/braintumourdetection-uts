...
##    os.environ["GIT_SSH_COMMAND"] = f"ssh -i {DEPLOY_KEY_PATH} -o IdentitiesOnly=####
...
##    os.makedirs(archive_path, exist_ok=####
...
##        return archived_model_file  # Return the path of the archived ####
...
##    shutil.rmtree(repo_path, ignore_errors=##
